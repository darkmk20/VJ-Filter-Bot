...
PICS = (environ.get('PICS', 'https://vault.pictures/p/9715d7d831754e54a47b0ea07179840d.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002346295952').split()]  # For Multiple Id Use One Space Between Each.
