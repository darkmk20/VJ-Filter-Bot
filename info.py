...
BOT_TOKEN = environ.get('BOT_TOKEN', "8058124753:AAEpKjMEUvjcXGoW0ec0OcMlwwn_fwYK5eQ")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002307452639').split()]  # For Multiple Id Use One Space Between Each.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'dm_discussion_group') # Support Chat Link Without https:// or @
