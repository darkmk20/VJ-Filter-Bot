...
BOT_TOKEN = environ.get('BOT_TOKEN', "7829238888:AAH0NtH7YHC-p_LLLjM28bBhSSuYjI3Th7M")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002417496242').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://autodarkvj:97uZCwkzhJ9JJqdp@cluster0.995ot.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
